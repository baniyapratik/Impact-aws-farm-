      ...
      <div className="container">
        <div className="section-heading text-center">
          ...
          <p className="text-muted">
            Check out what you can do with our platform!
          </p>
          <hr />
        </div>
        <div className="row">
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="feature-item">
                    ...
                    <p className="text-muted">
                      Ready to use devices, no waiting required!
                    </p>
                  </div>
                </div>
                <div className="col-lg-6">
                  <div className="feature-item">
                    ...
                    <h3>Easy to Use</h3>
                    <p className="text-muted">
                      Easy to pick up and use with our visually elagent UI!
                    </p>
                  </div>
                </div>
              </div>
              <div className="row">
                <div className="col-lg-6">
                  <div className="feature-item">
                    ...
                    <p className="text-muted">
                      Choose the perfect plan for you from our different testing
                      options!
                    </p>
                  </div>
                </div>
                <div className="col-lg-6">
                  <div className="feature-item">
                    ...
                    <p className="text-muted">
                      Know exactly how your money is being utilized and save
                      more!
                    </p>
                  </div>
                </div>
